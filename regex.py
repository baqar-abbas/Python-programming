...
if x:
  print(x.span()) # returns the position of the first match in the string
...
# match()	Returns a string if there is a match at the beginning of the string, otherwise returns None
